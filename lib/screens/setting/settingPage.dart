...
class _OurSettingPageState extends State<OurSettingPage> {
        ...
        body: GridView.count(
          ...
          children: <Widget>[
            ListTile(
              ...
              onTap: () {
                _navigateAndDisplayUsernamesUpdateForm(context);
              },
            ),
            ListTile(
              title: Card(
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    new MaterialPageRoute(
                        builder: (BuildContext context) => new UpdateMail()));
              },
            ),
            ListTile(
              title: Card(
  ...
  _navigateAndDisplayUsernamesUpdateForm(BuildContext context) async {
